...
public class StudentPortal_GUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StudentPortal_GUI frame = new StudentPortal_GUI();
	...
	public StudentPortal_GUI() {
		...
		JButton btnNewButton_2 = new JButton("View Attendance");
		...
		btnNewButton_6.setMinimumSize(new Dimension(150, 100));
