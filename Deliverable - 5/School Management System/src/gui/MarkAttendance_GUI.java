...
public class MarkAttendance_GUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MarkAttendance_GUI frame = new MarkAttendance_GUI();
	...
	public MarkAttendance_GUI() {
		...
		comboBox_1_1_1.setModel(new DefaultComboBoxModel(new String[] {"Select Date"}));
		comboBox_1_1_1.setToolTipText("\r\n");
		comboBox_1_1_1.setPreferredSize(new Dimension(200, 30));
		comboBox_1_1_1.setMinimumSize(new Dimension(100, 5));
		comboBox_1_1_1.setMaximumSize(new Dimension(200, 30));
		comboBox_1_1_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		comboBox_1_1_1.setBackground(Color.WHITE);
		horizontalBox_3.add(comboBox_1_1_1);
		...
		comboBox_1_1_1_1.setModel(new DefaultComboBoxModel(new String[] {"Select Month"}));
		comboBox_1_1_1_1.setToolTipText("\r\n");
		comboBox_1_1_1_1.setPreferredSize(new Dimension(200, 30));
		comboBox_1_1_1_1.setMinimumSize(new Dimension(100, 5));
		comboBox_1_1_1_1.setMaximumSize(new Dimension(200, 30));
		comboBox_1_1_1_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		comboBox_1_1_1_1.setBackground(Color.WHITE);
		horizontalBox_3.add(comboBox_1_1_1_1);
		...
		comboBox_1_1_1_2.setModel(new DefaultComboBoxModel(new String[] {"Select Year"}));
		comboBox_1_1_1_2.setToolTipText("\r\n");
		comboBox_1_1_1_2.setPreferredSize(new Dimension(200, 30));
		comboBox_1_1_1_2.setMinimumSize(new Dimension(100, 5));
		comboBox_1_1_1_2.setMaximumSize(new Dimension(200, 30));
		comboBox_1_1_1_2.setFont(new Font("Tahoma", Font.PLAIN, 12));
		comboBox_1_1_1_2.setBackground(Color.WHITE);
		horizontalBox_3.add(comboBox_1_1_1_2);
